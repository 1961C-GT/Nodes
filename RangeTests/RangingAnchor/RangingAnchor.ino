...
void setup() {
    ...
    Serial.println("Type to continue");
...
void loop() {
    if(counter >= 1000){
      ...
      float total = sum / 1000.0;
      Serial.print("Range: "); Serial.print(total); Serial.print(" m");
      for(;;);
    }
    ...
    if (receivedAck) {
        ...
        if (msgId == POLL) {
            ...
            if (!protocolFailed) {
                ...
                sum += distance;
                counter ++;
                Serial.print(counter); Serial.print("| Range: "); Serial.print(distance); Serial.print(" m");
